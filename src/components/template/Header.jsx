...
function Header({data}) {
  ...
  return data ? (
    ...
    className='header w-full h-[50vh] flex flex-col justify-end px-[2vw] pb-[1vw] '>
      ...
      <Link to={`/${data.media_type}/details/${data.id}/trailer`} className='trailer-btn text-[1vw] bg-[#6556CD] w-fit px-[0.6vw] py-[0.35vw] rounded-full'>Watch Trailer</Link>
    </div>
  ) : <div>Loading</div>
}
