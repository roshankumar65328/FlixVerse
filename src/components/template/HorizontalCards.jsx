...
function HorizontalCards({data}) {
  ...
  return (
      ...
      <div className='horizontal-card w-[100%] gap-[0.8vw] flex overflow-x-auto bg-[#1F1E24]' >
        {data.length > 0 ? data.map((d,i)=>{
          return <Link to={`/${d.media_type}/details/${d.id}`}  key={i} className='horizontal-card-link min-w-[20%]  h-[52vh] px-[1vw] py-[1vw]  bg-zinc-800'>
